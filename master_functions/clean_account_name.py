...
def clean_account_name(account_name):
    ...
    if account_name[-5:] == " tech":
        account_name = account_name[:-5] + " technologies"

    if account_name[-3:] == " st":
        account_name = account_name[:-3] + " street"

    if account_name[:4] == "l-3 ":
        account_name = "l3 " + account_name[4:]
